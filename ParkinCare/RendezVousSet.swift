...
//
//getNextRendezVous: RendezVousSet -> RendezVous
//Renvoie le prochain rendez-vous en date
//
//getDailyRendezVous: RendezVousSet x Date -> RendezVousSet
//Renvoie les rendez-vous de la journee entree en parametre
//
